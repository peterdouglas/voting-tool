 ...
 */
  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .whenAuthenticated('/myPolls', {
        templateUrl: 'views/myPolls.html',
        controller: 'MyPollsCtrl as myPolls'
      })
      .whenAuthenticated('/addPoll', {
        templateUrl: 'views/addPoll.html',
        controller: 'AddPollCtrl as addPoll'
      })
      .whenAuthenticated('/editPoll/:pollId', {
        templateUrl: 'views/editPoll.html',
        controller: 'EditPollCtrl as editPoll'
      })
